...
<!DOCTYPE html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                $doc_id=$_GET['doc_id'];
                $ret="SELECT  * FROM quarantine_camp_staff WHERE Quarantine_camp_Staff_ID=?";
                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-centre mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Full Name :</strong> <span class="ml-2"><?php echo $row->Name;?> <?php echo $row->doc_lname;?></span></p>
                                       <p class="text-muted mb-2 font-13"><strong>Department :</strong> <span class="ml-2"><?php echo $row->doc_dept;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Employee Number :</strong> <span class="ml-2"><?php echo $row->Quarantine_camp_Staff_ID;?></span></p>
